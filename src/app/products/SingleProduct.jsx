...
const SingleProduct = ({ product }) => {
  ...
  return (
    <Link href={`/products/${_id}`}>
      <div className="card card-compact bg-base-100 shadow-sm hover:shadow h-full justify-between border border-sky-100 hover:border-sky-200 ">
        <figure>
          <Image
            src={imageUrl}
            alt={title}
        ...
        <div className="card-body flex-row-0">
